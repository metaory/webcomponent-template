...
├── README.md            # Component-specific documentation (generated from LIB_README.md)
├── LICENSE              # MIT license
...
**📝 Note**: The scaffold script automatically replaces the template README with component-specific documentation from `LIB_README.md`.
